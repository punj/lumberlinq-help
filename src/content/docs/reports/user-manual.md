...
description: Step-by-step guide for running and exporting LumberLinq's 11 built-in reports.
---

## Reports

Open **Reports** from the main menu and choose the report you need. Each report is designed for a different operational view:
...
- **Consignment Report** (labelled Consignment Report in the menu; still "Shipment" in URLs) — Review shipments by trade type, payment status, volume, ports, parties, and BL number.
...
- **App Usage Report** (labelled **Analytics** in the menu) — Review application activity and usage patterns.
...
- **Consignment Report**: Overview, Transactions, Financial.
...
Reports are responsive. On smaller screens, tables and controls remain available with scrollable layouts where needed.
